This app is designed to help people who suffer from solar flares, pressure changes, or both. 

If you want to use it - run main.py , the onefile .exe will come soon.

The application can work in tray, the default notification timer is set to 30 minutes.
